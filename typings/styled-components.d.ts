...
declare const styled: styledComponents.ThemedBaseStyledInterface<ResolvedThemeInterface>, css: styledComponents.ThemedCssFunction<ResolvedThemeInterface>, injectGlobal: {
    ...
    (strings: string[] | TemplateStringsArray, ...interpolations: styledComponents.SimpleInterpolation[]): void;
}, keyframes: {
    (strings: TemplateStringsArray, ...interpolations: styledComponents.SimpleInterpolation[]): string;
    (strings: string[] | TemplateStringsArray, ...interpolations: styledComponents.SimpleInterpolation[]): string;
}, ThemeProvider: ComponentClass<styledComponents.ThemeProviderProps<ResolvedThemeInterface>>;
