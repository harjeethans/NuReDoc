...
export declare const StyledResponseTitle: StyledComponentClass<ResponseTitleProps, ResolvedThemeInterface, Pick<ResponseTitleProps, "code" | "title" | "type" | "className" | "onClick" | "empty" | "opened"> & {
